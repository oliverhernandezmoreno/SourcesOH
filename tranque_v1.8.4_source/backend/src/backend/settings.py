...
AMQP_VHOST = (lambda vhost: vhost if vhost.startswith("/") else f"/{vhost}")(
...
SMC_AMQP_VHOST = (lambda vhost: vhost if vhost.startswith("/") else f"/{vhost}")(
    os.environ.get("SMC_AMQP_VHOST", "/")
)
