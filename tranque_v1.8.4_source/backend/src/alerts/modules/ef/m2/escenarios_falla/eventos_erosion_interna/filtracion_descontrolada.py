...
PROFILE_DESCRIPTIONS = {
    "D1": "Se detecta evidencia de filtraciones en el muro, combinadas con alta \
    presión de poros, turbidez del sistema de drenaje, aparición de grietas o \
    reducción de la distancia entre la laguna de aguas claras y el muro. \n\n\
...
class Controller(ErosionInternaController):
    name = "Erosión interna producto de filtración descontroladas. "
    ...
    visibility_groups = (
        *ErosionInternaController.visibility_groups,
        "ef.m2.escenarios_falla.eventos_erosion_interna.filtracion_descontrolada",
    )

    _relevant_events = ["D1"]

    TEMPLATE = 'ef-mvp.m2.failure_scenarios.ei-01'
