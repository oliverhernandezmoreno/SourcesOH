...
from alerts.modules.base_states import EVENT_STATES, NO_LEVEL, ALERT_STATES
...
class BaseTestController(base.BaseController):
    states = StringEnum(*EVENT_STATES, *ALERT_STATES)
    ...
    def get_level(self, ticket):
        if ticket.state_group == EVENT_STATES.A:
            ...
            return 4
        elif ticket.state_group == ALERT_STATES.YELLOW:
            return 5
        elif ticket.state_group == ALERT_STATES.RED:
            return 6
        return NO_LEVEL
