...
if (utils.isDefined(errorPermitido) &&
  ...
  let presenciaEventA1 = undefined;
  if (depositacionValue_errorPermitidoValue < parseFloat(tonelajeValue))
    presenciaEventA1 = TONELAJE_YES;
  else
    presenciaEventA1 = TONELAJE_NO;

  series.yield(presenciaEventA1, {meta: {depositacionValue, errorPermitidoValue, depositacionValue_errorPermitidoValue, tonelajeValue}});
}
