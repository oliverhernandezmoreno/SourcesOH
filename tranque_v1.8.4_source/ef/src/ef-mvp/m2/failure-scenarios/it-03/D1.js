...
let eventsModuloResistenciaCorteMuroD1 = await series.queryAll({head:
  "*.modulos-deformacion-resistencia-muro.D1"});

if (!utils.isDefined(eventsModuloResistenciaCorteMuroD1) || eventsModuloResistenciaCorteMuroD1.length == 0) {
  eventsModuloResistenciaCorteMuroD1 = await refs.getMany("*.modulos-deformacion-resistencia-muro.D1");
}

if (!utils.isDefined(eventsModuloResistenciaCorteMuroD1) || eventsModuloResistenciaCorteMuroD1.length == 0) {
  eventsModuloResistenciaCorteMuroD1 = await refs.expand("*.modulos-deformacion-resistencia-muro.D1");
}

if (!utils.isDefined(eventsModuloResistenciaCorteMuroD1) || eventsModuloResistenciaCorteMuroD1.length == 0) {
  eventsModuloResistenciaCorteMuroD1 = await series.query({head: "*.modulos-deformacion-resistencia-muro.D1"});
}

if (!utils.isDefined(eventsModuloResistenciaCorteMuroD1) || eventsModuloResistenciaCorteMuroD1.length == 0) {
  eventsModuloResistenciaCorteMuroD1 = await refs.getOne("*.modulos-deformacion-resistencia-muro.D1");
}

if (!utils.isDefined(eventsModuloResistenciaCorteMuroD1) || eventsModuloResistenciaCorteMuroD1.length == 0) {
  eventsModuloResistenciaCorteMuroD1 = await refs.match("*.modulos-deformacion-resistencia-muro.D1");
}
