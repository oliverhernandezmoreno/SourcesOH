...
test("script false true when: "+
  ...
  const refsGetManyMock = async (eventsModuloResistenciaCorteMuroC2) => ({
    // Condicion: Módulo de rigidez y resistencia al corte del muro: (Evento C2)
    "*.modulos-deformacion-resistencia-muro.C2": eventsModuloResistenciaCorteMuroC2
  })[eventsModuloResistenciaCorteMuroC2];
  const refsExpandMock = async (eventsModuloResistenciaCorteMuroC2) => ({
    // Condicion: Módulo de rigidez y resistencia al corte del muro: (Evento C2)
    "*.modulos-deformacion-resistencia-muro.C2": eventsModuloResistenciaCorteMuroC2
  })[eventsModuloResistenciaCorteMuroC2];
  const refsGetOneMock = async (eventsModuloResistenciaCorteMuroC2) => ({
    // Condicion: Módulo de rigidez y resistencia al corte del muro: (Evento C2)
    "*.modulos-deformacion-resistencia-muro.C2": eventsModuloResistenciaCorteMuroC2
  })[eventsModuloResistenciaCorteMuroC2];
  const refsMatchMock = async (eventsModuloResistenciaCorteMuroC2) => ({
    // Condicion: Módulo de rigidez y resistencia al corte del muro: (Evento C2)
    "*.modulos-deformacion-resistencia-muro.C2": eventsModuloResistenciaCorteMuroC2
  })[eventsModuloResistenciaCorteMuroC2];
  const assertMock = (x) => {
