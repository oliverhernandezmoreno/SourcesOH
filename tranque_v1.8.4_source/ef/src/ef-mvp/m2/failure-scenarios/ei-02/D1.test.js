...
test("script return true when: "+
  ...
  const eventsConfirmacionManualD1 = [{value: EROSION_INTERNA_PRODUCTO_SUBSIDENCIAS_CUBETA_MURO_YES}];
  ...
  const eventsDistanciaLagunaC1 = [{value: EROSION_INTERNA_PRODUCTO_SUBSIDENCIAS_CUBETA_MURO_YES}];
