...
test("script return false when: "+
  "Evento C1 de Condiciones asociadas a los escenarios de falla Módulo 2 "+
  "Re-01 Rebalse por pérdida de revancha hidráulica durante lluvia intensa", async () => {
  ...
  const potencialRebalseB4 = [{value: REBALSE_PERDIDA_REVANCHA_HIDRAULICA_LLUVIA_INTENSA_NO}];
