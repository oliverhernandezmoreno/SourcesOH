...
if (
  ...
  // Condicion: Evento gatillador: Lluvia en desarrollo (Evento B)
  const eventLluviaB1Value = getValueFromArrayEvents(eventsLluviaB1,
    "*.lluvia");

  // Condicion: Revancha hidráulica: (Evento B1)
  const eventRevanchaHidraulicaB1Value = getValueFromArrayEvents(eventsRevanchaHidraulicaB1,
    "*.revancha-hidraulica.B1");

  // Condicion: Potencial de rebalse: (Evento B4)
  const eventPotencialRebalseB4Value = getValueFromArrayEvents(eventsPotencialRebalseB4,
    "*.potencial-rebalse.B4");

  // Condicion: Potencial de rebalse: (Evento B3)
  const eventPotencialRebalseB3Value = getValueFromArrayEvents(eventsPotencialRebalseB3,
    "*.potencial-rebalse.B3");
