...
test("script false when: "+
  ...
  const eventsDeslizamientoMenor = [{value: INESTABILIDAD_POR_DESLIZAMIENTO_MURO_NO}];
  // Condicion: Evidencia de grietas en el muro del depósito: (Evento C3)
  const eventsEvidenciaGrietasC3 = [{value: INESTABILIDAD_POR_DESLIZAMIENTO_MURO_NO}];
