terraform init -backend-config="storage_account_name=deployed" -backend-config="container_name=tfstat" -backend-config="access_key=4yLnNXEa7P2lWUMaSTeWmnE3BrpLNHiyz3epB1wlx/ZRqIEtB7AXKBUwVDiR0ouy5W4WUHSYrABvNCWZzm8S+A==" -backend-config="key=codelab.microsoft.sngm"
