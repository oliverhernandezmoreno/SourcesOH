...
import {getTargetDisconnections, hasActiveDisconnection} from '@authorities/services/disconnections';
 ...
 * @public
 */
export const generateTableData = (res, indexesData, ticketsData, disconnectionsData, availability) => {
    const data = res.map(
        item => {
            ...
            const targetDisconnections = getTargetDisconnections(item.canonical_name, disconnectionsData);
            return {
                name: item.name,
                ...
                disconnectedAlertEF: hasActiveDisconnection(targetDisconnections, EF_CANONICAL_NAME),
                disconnectedAlertEMAC: hasActiveDisconnection(targetDisconnections, EMAC_CANONICAL_NAME),
