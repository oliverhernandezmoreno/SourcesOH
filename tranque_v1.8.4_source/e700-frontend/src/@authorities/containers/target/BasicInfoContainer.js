...
import Cameras from '@authorities/components/target/camera/Cameras';
...
export const BasicInfoContainer = withStyles(styles)(class extends SubscribedComponent {
    ...
    render() {
        const {target, entityName, regionName, comunaName, workSiteName, classes, cameras, videoFrames} = this.props;
