...
import {Typography, Link, Card, CardContent, Grid, Divider, withStyles} from '@material-ui/core';
...
import { getGroup, groupNames } from '@alerts_events/constants/ticketGroups';
...
class RequestListCard extends Component {
    ...
    render() {
        ...
        return (<Link target="_blank" href={'#' + onClick()}>
