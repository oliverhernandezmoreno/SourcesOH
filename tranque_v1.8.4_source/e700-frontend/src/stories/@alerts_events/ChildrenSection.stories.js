...
storiesOf('Alerts&Events/ticket-detail/ChildrenSection', module)
    ...
    .add('Miner user view example', () => (<div style={divStyle}>
        <ChildrenSection user={minerUser} ticket={getTicket({children: [getChild(A, 1),
            getChild(B, 2),
            getChild(C, 3),
            getChild(D, 4),
    ...
    .add('Authority user view example', () => (<div style={divStyle}>
        <ChildrenSection user={authorityUser} ticket={getTicket({children: [getChild(A, 1),
            getChild(B, 2),
            getChild(C, 3),
            getChild(D, 4),
            getChild(YELLOW_ALERT, 5),
    ...
    .add('No children', () => (<div style={divStyle}>
        <ChildrenSection user={minerUser} ticket={getTicket({children: []})}/>
    </div>))
    .add('Miner user with closed children', () => (<div style={divStyle}>
        <ChildrenSection user={minerUser} ticket={getTicket({children: [getChild(CLOSED, 1),
            getChild(CLOSED, 2),
            getChild(CLOSED, 3),
            getChild(CLOSED, 4),
            getChild(CLOSED, 5),
