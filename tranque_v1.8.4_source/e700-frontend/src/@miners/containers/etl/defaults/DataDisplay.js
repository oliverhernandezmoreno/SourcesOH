...
import {getFormattedError} from '@miners/containers/etl/defaults/error-messages';
...
class DataDisplay extends SubscribedComponent {
    state = {
        data: null,
        loading: false,
        error: false,
    ...
    renderErrorItem(error, index) {
        const message = getFormattedError(this.props.operation.executor, error);
        if (message === null) {
            return null;
        }
        const {primary, secondary} = message;
        return (
            ...
            <>
                ...
                {this.state.error && (
                    <Grid container direction="row" alignItems="center">
                        ...
                        <Grid item>
                            <IconButton title="Reintentar" onClick={this.loadData.bind(this)}>
                                <Refresh />
                            </IconButton>
                        </Grid>
                    </Grid>
