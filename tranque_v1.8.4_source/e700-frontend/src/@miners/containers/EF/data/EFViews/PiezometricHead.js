...
class PiezometricHead extends SubscribedComponent {
                    ...
                    <div className={classes.content}>
                        {
                            plotTemplates.map(plotTemplate => {
                                ...
                                let linesStyles = metaData.map((row, index) => {
                                    ...
                                    const group = rowGroups.find(group => group === plotTemplate.config.getRowGroupLabel(row));
                                    ...
                                    <Card className={classes.content__timeseries} key={plotTemplate.title}>
                                        ...
                                        <div className={classes.map}>
                                            <InstrumentsMapContainer
                                                ...
                                                dataSources={metaData && metaData.map(data => data.data_source)}
                                            />
                                        </div>
                                    </Card>
                                )
...
PiezometricHead.propTypes = {
    classes: PropTypes.object.isRequired
};

export default connect(MapStateToProps, null)(withStyles(styles)(PiezometricHead));
