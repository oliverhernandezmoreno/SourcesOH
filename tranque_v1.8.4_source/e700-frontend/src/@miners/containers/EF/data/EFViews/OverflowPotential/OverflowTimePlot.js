    ...
    loadTimeseriesData = () => {
        ...
        this.subscribe(
            ...
            ({ overflowPotential, overflowPotentialList, }) => {
                ...
                const descriptionLists = [...overflowPotentialList];
    ...
    render = () => {
        ...
        return (
            ...
            <SelectableTimeseries
                ...
                gapsData={this.props.vegaDataGaps}
                isTemporal={true}
                ...
                exportProps={(() => {
                    ...
                    return {
                        target: this.props.target,
                        filename: 'Tiempo_de_rebalse.xlsx',
                        canonical_name: [overflowPotentialCanonicalName],
                ...
                xDomain={[this.props.filters.startDate.format('YYYY-MM-DD'), this.props.filters.endDate.format('YYYY-MM-DD')]}
