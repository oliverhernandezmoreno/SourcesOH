...
import {Card, Typography, Select, MenuItem, Link, InputLabel, FormControl,
                ...
                <Card className={classes.root}>
                    ...
                    <div className={classes.content}>
                        ...
                        <div className={classes.content__details} >
                            <div className={classes.details__section}>
                                ...
                                <SwitchBox
                                    ...
                                    switchProps={{
                                        ...
                                        disabled: particleAtOutletSwitchData?.events?.[0]?.value === undefined || this.props.disableActions
                                    }}
                            ...
                            <DataSourceSheet
                                target={this.props.target}
                                dataSource={turbidimeterData?.data_source}
                                fileData={fileData}
