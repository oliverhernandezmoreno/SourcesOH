    ...
    return [
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    path: reverse('miners.target.ef.dataLoad.fromFile', { target, executor: 'ef_parameter:pendiente_playa' })
                },
                {
                ...
                {
                    subtitle: 'Deformaciones'
                },
                {
                    title: 'Deformación superficial del muro',
                    path: reverse('miners.target.ef.dataLoad.fromFile', { target, executor: 'ef_deformation_monoliths' })
                },
                {
                    title: 'Deformación interna del muro y suelo de fundación',
                    path: reverse('miners.target.ef.dataLoad.fromFile', { target, executor: 'ef_deformation_inclinometers' })
                },
                {
        ...
        },
        {
            ...
            children: [
                ...
                {
                    title: 'Pendiente de playa',
                    path: reverse('miners.target.ef.registry.operationList', { target, executor: 'ef_parameter:pendiente_playa' })
                },
                {
                    subtitle: 'Granulometría y densidad'
                },
                ...
                {
                    title: 'Deformación superficial del muro',
                    path: reverse('miners.target.ef.registry.operationList', { target, executor: 'ef_deformation_monoliths' })
                },
                {
                    title: 'Deformación interna del muro y suelo de fundación',
                    path: reverse('miners.target.ef.registry.operationList', { target, executor: 'ef_deformation_inclinometers' })
                },
                {
...
function timeSeriesNav(target) {
    return [
        ...
        {
            title: 'Acelerógrafos',
            path: getTimeseriesNavPath(target, 'acelerografos')
        },
        {
            title: "Documentos",
            children: [
...
export function getEFDrawerItems(target) {
    return [
        ...
        },
        {
            ...
            path: reverse('miners.target.info', { target }),
            icon: 'Videocam',
        }
    ];
}
