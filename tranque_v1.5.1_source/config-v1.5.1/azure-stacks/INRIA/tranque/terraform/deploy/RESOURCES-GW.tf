...
resource "azurerm_application_gateway" "appgw" {
  ...
  http_listener {
    ...
    #"${azurerm_dns_a_record.www.name}.${azurerm_dns_zone.public.name}"
  }
  ...
  http_listener {
    ...
    protocol                       = "Https"
    host_name                      = "${azurerm_dns_a_record.www.name}.${azurerm_dns_zone.public.name}"
  ...
  http_listener {
    ...
    frontend_port_name             = local.gw_port_https
    protocol                       = "Https"
    host_name                      = "${azurerm_dns_a_record.minio.name}.${azurerm_dns_zone.public.name}"
  ...
  http_listener {
    ...
    frontend_port_name             = local.gw_port_https
    protocol                       = "Https"
    host_name                      = "${azurerm_dns_a_record.api.name}.${azurerm_dns_zone.public.name}"
  ...
  http_listener {
    ...
    frontend_port_name             = local.gw_port_https
    protocol                       = "Https"
    host_name                      = "${azurerm_dns_a_record.static.name}.${azurerm_dns_zone.public.name}"
