...
resource "azurerm_key_vault_certificate" "w2" {
  ...
  certificate {
    contents = filebase64("./cert/pem/w2.contratoagil.cl/cert-w2.pfx")
    password = ""
  }
...
resource "azurerm_key_vault_certificate" "www" {
  ...
  certificate {
    contents = filebase64("./cert/pem/www.contratoagil.cl/cert-www.pfx")
    password = ""
  }
...
resource "azurerm_key_vault_certificate" "static" {
  ...
  certificate {
    contents = filebase64("./cert/pem/static.contratoagil.cl/cert-static.pfx")
    password = ""
  }
