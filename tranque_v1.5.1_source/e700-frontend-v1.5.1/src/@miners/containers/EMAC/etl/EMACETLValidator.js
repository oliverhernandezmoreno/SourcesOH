...
class EMACETLValidator extends SubscribedComponent {
    state = {
        delivering: false,
        error: null,
        loading: false
    ...
    render() {
        ...
        return (
            <Card>
                <CardHeader avatar={<Avatar><UnarchiveOutlinedIcon/></Avatar>}
                    ...
                    <Grid container direction="row" justify="space-around">
                        <Grid item xs={4}>
                            <Button variant="contained"
                                fullWidth
                                size="large"
                                onClick={() => history.push(reverse(this.props.spec.loaderRoute, {
                                    target,
                                    executor
                                }))}>
                                <ChevronLeft/>
...
export default withStyles(styles)(EMACETLValidator);
