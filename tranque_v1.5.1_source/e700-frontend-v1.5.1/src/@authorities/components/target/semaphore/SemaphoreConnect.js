...
class SemaphoreConnect extends Component {
    ...
    render() {
        const {classes, target, ticket, publicMessage, scope, alertStatusColor} = this.props;
        ...
        return (<Box mt={2}>
                ...
                <Grid container className={classNames(classes.marginTop, classes.marginBottom)} alignItems="center">
                    ...
                    <Grid item xs={10}>
                        <Box display="flex" height="100%" alignItems="flex-end">
                            <Typography variant="body1">{publicMessage ? publicMessage : emptyPublicMessage}</Typography>
                        </Box>
                    </Grid>
                </Grid>
                <hr/>
            ...
            <Box mt={2} display="flex" justifyContent="flex-end">
                <ConnectSemaphoreButton handleConnection={null} target={target} scope={scope}/>
            </Box>
        </Box>);
    }
}
