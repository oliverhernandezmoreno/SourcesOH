...
test("script return true when " +
  "Si plan de depositación (Fecha) mas error permitido menor a tonelaje (fecha)", async () => {
  ...
  const errorPermitido = {value: 1};
  const tonelaje = {
    value: 194500,
    '@timestamp': "2020-05-08T00:00:00"
  };
