...
test("script return 1 when value of filtracion is 1 and terrremoto is 0", async () => {
...
test("script return 0 when value of filtracion is 1 and terrremoto is 1", async () => {
