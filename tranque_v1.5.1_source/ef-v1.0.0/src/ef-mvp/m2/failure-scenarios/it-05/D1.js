...
console.log("eventsIntegridadExternaEstribosC1:"+JSON.stringify(eventsIntegridadExternaEstribosC1));
...
console.log("eventsIntegridadExternaEstribosD1:"+JSON.stringify(eventsIntegridadExternaEstribosD1));
...
console.log("eventsIntegridadExternaFiltracionesC1:"+JSON.stringify(eventsIntegridadExternaFiltracionesC1));
...
console.log("eventsIntegridadExternaFiltracionesC2:"+JSON.stringify(eventsIntegridadExternaFiltracionesC2));
...
console.log("eventsDistanciaLagunaC1:"+JSON.stringify(eventsDistanciaLagunaC1));
