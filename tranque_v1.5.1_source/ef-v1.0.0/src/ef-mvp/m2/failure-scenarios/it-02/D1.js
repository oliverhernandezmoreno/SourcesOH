...
if (
  ...
  utils.isDefined(eventsCoronamientoMonolitoEjeZC3)) {
    ...
    // Condicion: Desplazamiento o deformación del muro: (Evento C1, C2, C3, C4 o C5)
    let eventMuroMonolitoEjeXC1Value = getValueFromArrayEvents(eventsMuroMonolitoEjeXC1, "*.muro.monolito.eje-x.C1");
    let eventMuroMonolitoEjeYC2Value = getValueFromArrayEvents(eventsMuroMonolitoEjeYC2, "*.muro.monolito.eje-y.C2");
    let eventMuroMonolitoEjeZC3Value = getValueFromArrayEvents(eventsMuroMonolitoEjeZC3, "*.muro.monolito.eje-z.C3");
    let eventMuroInclinometroEjeXC4Value = getValueFromArrayEvents(eventsMuroInclinometroEjeXC4, "*.muro.inclinometro.eje-x.C4");
    let eventMuroInclinometroEjeYC5Value = getValueFromArrayEvents(eventsMuroInclinometroEjeYC5, "*.muro.inclinometro.eje-y.C5");
    let eventMuroInclinometroEjeZC6Value = getValueFromArrayEvents(eventsMuroInclinometroEjeZC6, "*.muro.inclinometro.eje-z.C6");

    // Condicion: Deformación del coronamiento: (Evento C1, C2 o C3)
    let eventCoronamientoMonolitoEjeXC1Value = getValueFromArrayEvents(eventsCoronamientoMonolitoEjeXC1, "*.coronamiento.monolito.eje-x.C1");
    let eventCoronamientoMonolitoEjeYC2Value = getValueFromArrayEvents(eventsCoronamientoMonolitoEjeYC2, "*.coronamiento.monolito.eje-y.C2");
    let eventCoronamientoMonolitoEjeZC3Value = getValueFromArrayEvents(eventsCoronamientoMonolitoEjeZC3, "*.coronamiento.monolito.eje-z.C3");
  ...
  series.yield(
    ...
    {meta: {
      ...
      // Condicion: Desplazamiento o deformación del muro: (Evento C1, C2, C3, C4 o C5)
      eventsMuroMonolitoEjeXC1, eventsMuroMonolitoEjeYC2,
      eventsMuroMonolitoEjeZC3, eventsMuroInclinometroEjeXC4, eventsMuroInclinometroEjeYC5,
      eventsMuroInclinometroEjeZC6,
      // Condicion: Deformación del coronamiento: (Evento C1, C2 o C3)
