...
console.log("eventsDeslizamientoMenor:"+JSON.stringify(eventsDeslizamientoMenor));
...
console.log("eventsEvidenciaGrietasC3:"+JSON.stringify(eventsEvidenciaGrietasC3));
